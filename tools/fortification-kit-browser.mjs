...
const out='artifacts/fortification-kit';await mkdir(out,{recursive:true});
...
const report=await page.evaluate(async()=>{
 ...
 for(const [id,module,x,z]of[['wall','tall-wall',-225,-65],['half','tall-half-wall',-188,-65],['corner','tall-corner',-150,-65],['pillar','tall-pillar',-108,-65],['closed-frame','tall-gate-frame',-50,-65],['open-frame','tall-open-gate',28,-65],['tower','tall-tower',95,-65],['bunker','bunker',170,-65]])add(id,module,x,z);
 add('closed-leaf','tall-closed-gate',-50,-65);add('roof-mount','aa-hardpoint',95,-65,{y:66});add('bunker-access','stairs',170,-109,{height:26,rotation:180});
 for(const [id,module,x]of[['low','low-wall',-220],['half-height','half-height-wall',-170],['barricade','barricade',-120],['bags','sandbag-barrier',-75],['fence','fence',-28],['steps','stairs',24],['ramp','ramp',62],['platform','raised-platform',112],['terminal','terminal-mount',160],['sensor','antenna-mount',190],['camera','camera-mount',216],['searchlight','searchlight-mount',240]])add(id,module,x,42);
