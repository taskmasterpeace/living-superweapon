...
for(const body of ['procedural','superhero-male','superhero-female'])test(`${body}: registered bat has a supported native swing`,()=>{
 ...
 const bat=buildWeapon('bat',{});alignWeaponGrip(bat,1);const hand=f.parts.armR.children[2];hand.add(bat);hand.userData.gripOccupied=true;hand.userData.gripKind='cylinder';
