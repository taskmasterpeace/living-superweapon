...
if(process.argv.includes('--rebuild')){
 run(process.env.BLENDER_PATH||'C:/Program Files/Blender Foundation/Blender 4.5/blender.exe',['--background','--python-exit-code','1','--python','tools/build-modular-character.py','--','assets-src/modular-character/source/AnimationLibrary_Godot_Standard.gltf','public/models/modular-hero']);
