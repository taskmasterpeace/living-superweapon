...
test('flight-only calibrated speed and boost label',()=>{const p=fighter();p.flying=true;p.cruiseHeld=true;assert.deepEqual(playerStatus(p).flight,{speed:3,label:'BOOST'});});
