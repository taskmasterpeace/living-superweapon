...
const out='artifacts/marketing/issues-14-16-native-'+(process.argv[2]||'round2');await mkdir(out,{recursive:true});
...
try{
 ...
 await page.mouse.click(720,450);await page.waitForFunction(()=>!!document.pointerLockElement);await page.waitForTimeout(250);await page.keyboard.down('Space');await page.waitForTimeout(3500);await page.keyboard.up('Space');await page.waitForTimeout(1200);await read('02-hover');
