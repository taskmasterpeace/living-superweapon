export const scenarios=Object.freeze({
 'rage-approach':{schemes:['kbm'],script:'rage-entry-browser.mjs',capture:'silent video and screenshots',description:'RAGE targets a stationary trainer at 46.8u and approaches using native melee.'},
