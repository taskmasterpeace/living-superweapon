export const scenarios=Object.freeze({
 'moving-strike':{schemes:['pad'],config:{scheme:'pad'},script:'moving-strike-browser.mjs',capture:'silent video and screenshots',description:'Hold controller movement while charging melee; require actual movement during charge and clean input release.'},
