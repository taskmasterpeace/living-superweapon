...
const out='artifacts/marketing/ambush-route-walk';await mkdir(out,{recursive:true});
...
try{
 ...
 const result=await page.evaluate(()=>{const g=window.PW.game,o=g.ms.convoyOperation;return {state:o.state,events:o.events,playerHp:g.player.hp,scientistHp:o.scientist.hp,save:g.campaign.snapshot()};});
