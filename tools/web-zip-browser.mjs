...
const page=await context.newPage(),result={baseUrl,scope:'Native Free practice WEBLINE Shift web zip against the actual command building, followed by release; no gameplay overrides',samples:[],errors:[]};
...
try{
 await page.goto(`${baseUrl}/powerworld.html?hero=webline`);
