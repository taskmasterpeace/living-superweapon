...
const out='artifacts/marketing/squad-transport-runtime';await mkdir(out,{recursive:true});
...
try{
 ...
 await page.evaluate(()=>{const g=window.PW.game,t=g.pwStage.transport;g.player.pos.copy(t.entry);g.player.pos.z+=10;g.player.vel.set(0,0,0);g.world._lookYaw=Math.PI;g.world._lookPitch=0;});await page.waitForTimeout(1000);await page.screenshot({path:out+'/boarding.png'});
