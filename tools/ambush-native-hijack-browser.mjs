...
const out='artifacts/marketing/ambush-native-hijack';await mkdir(out,{recursive:true});
...
try{
 ...
 await walk('vehicle',4);await page.keyboard.press('j');await page.waitForFunction(()=>!!window.PW.game.player._scoutVehicle,{},{timeout:5000});await page.waitForFunction(()=>window.PW.game.ms.convoyOperation.state==='disabled',{},{timeout:5000});await page.screenshot({path:out+'/intercepted.png'});await page.keyboard.press('j');await page.waitForTimeout(400);
