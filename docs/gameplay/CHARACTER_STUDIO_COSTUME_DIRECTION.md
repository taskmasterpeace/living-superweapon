...
Current foundation: ten authored clips cataloged and previewed; local contact-marker drafts save/reload/revert/export. Validated marker variants for jab, cross and power can now be assigned through character profiles and sampled by native combat; this changes presentation mapping, not damage or attack timing. Existing Studio profiles already supply portions of frame/palette/model customization. Still open: procedural catalog/preview, broader shared move-family assignments, modular costume registry and complete appearance parity proof. Follow #23 and #35; preserve the combat-and-movement goal.
