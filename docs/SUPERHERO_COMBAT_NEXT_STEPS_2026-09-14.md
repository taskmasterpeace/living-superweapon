...
- Person throws now retain the victim during .20-second anticipation, sample aim at the physical release marker and extend both arms along the committed throw direction before recovery. This procedural transition still needs visual acceptance across body sizes/directions; it is not a newly imported wrestling clip. See `PAIRED_THROW_AUDIO_CHECKPOINT_2026-09-14.md`.
