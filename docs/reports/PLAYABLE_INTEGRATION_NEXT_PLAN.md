...
- First complete operation interview is still pending: recovery/cloning vs escort vs ambush. Build shared combat/readability foundations while it is pending; do not treat a recommendation as the user's answer.
