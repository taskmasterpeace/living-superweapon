...
|---|---|---|---|---|---|---|
| **SOL** | the solar standard | USA (Kansas drawl) | Very High | 8 | 1.3 | Heat Ray, Arctic Breath (freezes solid), Sky Smash |
| **KANO** | the joyful spirit warrior | Japan | Very High | 6 | 1.3 | Wave Cannon charge beam, Snap Transit, Star Sphere |
| **VEGA** | the proud rival | Japan (imperious) | Very High | 7 | 1.2 | Volley volley, Nova Burst, Final Arc |
...
| **SARGE** | the last soldier | USA (gravel) | **Low** | 4 | 1.0 | Pulse carbine, hand cannon, plasma blade, riot shield, Airstrike, Combat Leap |
...
| `deflect` | VANGUARD, TITAN | Front-arc + **projectiles/bullets/arrows reflect back at the shooter** (against a gunman his own magazine feeds you) |
