...
## Current build and gameplay reel

- Mobile: compact status HUD pinned at the top, touch-native attack names, rifle sight and reload buttons.
- Desktop: Pause → **HUD position & size** to drag, resize, reset and save the status panel.
- [37-second gameplay showcase](public/showcase/living-superweapon-gameplay.mp4) — real Practice footage, silent, work in progress. [Recording manifest](public/showcase/source-manifest.json).
- [Current findings and remaining work](docs/reports/2026-09-10-creator-status-and-priorities.md).
- [Weather and creature/animation roadmap](docs/reports/2026-09-10-weather-and-asset-roadmap.md). Aircraft expansion is deferred.

![Gameplay showcase poster](public/showcase/living-superweapon-poster.jpg)
