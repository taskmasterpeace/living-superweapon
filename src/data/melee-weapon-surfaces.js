...
export const MELEE_WEAPON_SURFACES={
 claws:{segments:[-1,0,1].map(i=>({from:[i*.22+Math.sin(i*.1)*.75,-.95-Math.cos(i*.1)*.75,.04],to:[i*.22-Math.sin(i*.1)*.75,-.95+Math.cos(i*.1)*.75,.04]})),radius:.09},
 bat:{from:[0,-1.5,0],to:[0,-3.75,0],radius:.24},
 sword:{from:[0,-.65,.16],to:[0,-3.55,.16],radius:.25},
 katana:{from:[0,-.25,0],to:[0,-3.55,0],radius:.16},
 nodachi:{from:[0,-1.12,0],to:[0,-5.55,0],radius:.20},
 knife:{from:[0,-.35,.16],to:[0,-1.55,.16],radius:.18},
 axe:{from:[-1.05,-2.6,.16],to:[1.05,-2.6,.16],radius:.45},
 spear:{from:[0,-3.5,.16],to:[0,-4.3,.16],radius:.22},
 baton:{from:[0,-.4,0],to:[0,-2,0],radius:.12},
};
