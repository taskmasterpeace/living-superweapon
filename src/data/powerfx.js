...
const F = {
  ...
  fire: {
    ...
    flight: { trail: ['#ff7a2a', '#ffd24a'], wake: '#ff5a2a' },
  ...
  ice: {
    ...
    flight: { trail: ['#bfeaff', '#ffffff'], wake: '#9fd8f0' },
  ...
  water: {
    ...
    flight: { trail: ['#3fa8d8', '#eafcff'], wake: '#2f88b8' },
  ...
  energyRed: {
    ...
    flight: { trail: ['#ff3b3b', '#fff0f0'], wake: '#e02a2a' },
  ...
  energyBlue: {
    ...
    flight: { trail: ['#3f8cff', '#f0f8ff'], wake: '#2a6ae0' },
  ...
  energySun: {
    ...
    flight: { trail: ['#ffd24a', '#ffffff'], wake: '#f0b830' },
  ...
  electric: {
    ...
    flight: { trail: ['#8ad8ff', '#ffffff'], wake: '#5ab8f0' },
  ...
  magicViolet: {
    ...
    flight: { trail: ['#a44df0', '#f8f0ff'], wake: '#8a3ad0' },
  ...
  magicGreen: {
    ...
    flight: { trail: ['#4fd86a', '#f0fff0'], wake: '#3ab850' },
  ...
  alien: {
    ...
    flight: { trail: ['#ff9a2a', '#fff8e8'], wake: '#e0801a' },
  ...
  toxic: {
    ...
    flight: { trail: ['#9adf3a', '#eaffd8'], wake: '#7ab82a' },
  ...
  steel: {
    ...
    flight: { trail: ['#c8c8c8'], wake: '#a0a0a4' },
