...
export const BLADES = [
  ...
  { id: 'katana', n: 'KATANA', mesh: 'katana', hero: true,
    ...
    ab: { type: 'melee', name: 'Katana', weapon: 'katana', gear: true, dmgClass: 'slash', dtype: 'physical',
  ...
  { id: 'claws', n: 'CLAWS', mesh: 'claws', hero: true,
    ...
    ab: { type: 'melee', name: 'Claws', weapon: 'claws', dmgClass: 'slash', dtype: 'physical',
  ...
  { id: 'knife', n: 'COMBAT KNIFE', mesh: 'knife', oneHand: true,
    ...
    ab: { type: 'melee', name: 'Combat Knife', weapon: 'knife', gear: true, oneHand: true, dmgClass: 'slash',
  ...
  { id: 'tomahawk', n: 'BREACHING TOMAHAWK', mesh: 'axe',
    ...
    ab: { type: 'melee', name: 'Breaching Tomahawk', weapon: 'axe', gear: true, dmgClass: 'slash', dtype: 'physical',
