...
export const FIREARMS = [
  ...
  { id: 'm24', n: 'M24 MARKSMAN RIFLE', cls: 'sniper', voice: 'sniper762', mesh: 'sniper',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'M24 Marksman Rifle', gear: true, cost: 3,
  ...
  { id: 'm107', n: 'M107 ANTI-MATERIEL', cls: 'sniper', voice: 'amr50', mesh: 'sniper',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'M107 Anti-Materiel', gear: true, cost: 6,
  ...
  { id: 'ak', n: 'AK PATTERN RIFLE', cls: 'rifle', voice: 'ak762', mesh: 'rifle',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'AK Pattern Rifle', gear: true, cost: 2,
  ...
  { id: 'm16', n: 'M16 RIFLE', cls: 'rifle', voice: 'ar556', mesh: 'rifle',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'M16 Rifle', gear: true, cost: 2,
  ...
  { id: 'battle', n: 'BATTLE RIFLE', cls: 'rifle', voice: 'battle762', mesh: 'rifle',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'Battle Rifle', gear: true, cost: 3,
  ...
  { id: 'saw', n: 'SQUAD AUTOMATIC', cls: 'lmg', voice: 'lmg762', mesh: 'rifle',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'Squad Automatic', gear: true, cost: 2,
  ...
  { id: 'mp5', n: 'MP5 SUBMACHINE GUN', cls: 'smg', voice: 'smg9', mesh: 'smg',
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'MP5 Submachine Gun', gear: true, cost: 1,
  ...
  { id: 'pdw', n: 'SUPPRESSED PDW', cls: 'smg', voice: 'supp', mesh: 'smg', quiet: true,
    ...
    ab: { type: 'rifle', weapon: 'rifle', name: 'Suppressed PDW', gear: true, cost: 1,
  ...
  { id: 'pump', n: 'COMBAT SHOTGUN', cls: 'shotgun', voice: 'shotgun12', mesh: 'shotgun',
    ...
    ab: { type: 'rifle', weapon: 'shotgun', name: 'Combat Shotgun', gear: true, cost: 6,
  ...
  { id: 'auto12', n: 'AUTO SHOTGUN', cls: 'shotgun', voice: 'shotgun12', mesh: 'shotgun',
    ...
    ab: { type: 'rifle', weapon: 'shotgun', name: 'Auto Shotgun', gear: true, cost: 5,
  ...
  { id: 'p9', n: '9MM SIDEARM', cls: 'pistol', voice: 'pistol9', mesh: 'pistol', oneHand: true,
    ...
    ab: { type: 'rifle', weapon: 'pistol', name: '9mm Sidearm', gear: true, oneHand: true, cost: 1,
  ...
  { id: 'magnum', n: '.44 REVOLVER', cls: 'pistol', voice: 'magnum', mesh: 'pistol', oneHand: true,
    ...
    ab: { type: 'rifle', weapon: 'pistol', name: '.44 Revolver', gear: true, oneHand: true, cost: 2,
  ...
  { id: 'machinepistol', n: 'MACHINE PISTOL', cls: 'pistol', voice: 'smg9', mesh: 'pistol', oneHand: true,
    ...
    ab: { type: 'rifle', weapon: 'pistol', name: 'Machine Pistol', gear: true, oneHand: true, cost: 1,
