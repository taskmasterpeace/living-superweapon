...
export const ROSTER = [
  ...
  {
    id: 'mystward', origin: 'spiritual', name: 'MAELSTROM', title: 'Keeper of the Seals', role: 'Mystic Defender',
    colors: { primary: '#7138a8', secondary: '#30184f', accent: '#b06aff', skin: '#5a3a28' },
    ...
    blurb: 'A Black male wizard of doors, wards, and sigils. He was a surgeon once; now he closes wounds in the world. The whip drinks the power right out of you.',
    abilities: {
  ...
  {
    id: 'moses', origin: 'altered', name: 'MOSES APIO', title: 'The Atlas Protocol', role: 'Gas / Solid Constructs',
    colors: { primary: '#7138a8', secondary: '#30184f', accent: '#b06aff', skin: '#5a3a28' },
    hp: 140, ki: 125, speed: 35, strength: 7, rank: 46, overdrive: 1.2, threat: 'High', flightTier: 1,
    ai: { style: 'zoner', range: 34, aggro: 0.6, fly: 0.2 }, evade: { kind: 'phase', name: 'Vapor Slip' },
    blurb: 'The Atlas Protocol: Moses Apio commands living purple gas that chokes, blinds, and turns solid on command. Hardened vapor forms a wall or a striking fist.',
    sig: ['LMB Choking Veil (lingering gas damage)', 'RMB Solid Vapor (wall)', 'E Blinding Cloud', 'H Hardened Vapor Fist'],
    abilities: {
      lmb: { type: 'cone', name: 'Choking Veil', dtype: 'toxic', kiPerSec: 17, range: 34, arc: 1.15, dps: 14, push: 6, gasDot: { dps: 7, dur: 2.6, color: '#9a4ae0', kind: 'gas' }, color: '#9a4ae0' },
      rmb: { type: 'construct', name: 'Solid Vapor', cost: 12, cd: 6, construct: 'wall', duration: 9, holdTrigger: true, color: '#9a4ae0' },
      q: { type: 'phase', name: 'Gas Form', kiPerSec: 17, color: '#b06aff' },
      e: { type: 'projectile', name: 'Blinding Cloud', dtype: 'toxic', cost: 8, cd: 0.5, damage: 12, speed: 54, radius: 1.9, blast: 9, homing: 1.6, payload: 'gas', blind: { r: 12, dur: 2.2 }, color: '#9a4ae0', color2: '#e8d0ff' },
      f: { type: 'construct', name: 'Hardened Vapor Fist', cost: 14, cd: 5, construct: 'fist', duration: 11, color: '#9a4ae0' },
      shift: { type: 'dash', name: 'Vapor Slip', cost: 5, cd: 0.55, power: 98, iframes: 0.26, color: '#b06aff' },
      r: { type: 'charge', name: 'Asphyxia', dtype: 'toxic', cost: 8, cd: 14, kiPerSec: 12, maxCharge: 2.3, minR: 1.8, maxR: 7, dmgMin: 22, dmgMax: 78, maxBlast: 36, speedMin: 32, speedMax: 56, chargePower: 3, color: '#9a4ae0', color2: '#e8d0ff' },
    },
  },
