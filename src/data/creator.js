...
export const POWERS = [
  ...
  // ---- TIER TWO, the remaining lanes (docs/POWERS_BRIEF.md Part Four) --------------------
  { id: 'stickybomb', name: 'Sticky Bomb',         cat: 'blast', cost: 20, ab: { type: 'projectile', name: 'Sticky Bomb', cost: 7, cd: 3.2, damage: 16, speed: 78, radius: 1.1, blast: 15, power: 1.5, grav: 0.5, canister: true, stick: { fuse: 1.6 }, color: '#ff8a3a', color2: '#ffd24a' } },
  { id: 'chainbolt2', name: 'Chain Lightning',     cat: 'blast', cost: 26, ab: { type: 'projectile', name: 'Chain Lightning', cost: 8, cd: 4, damage: 20, speed: 130, radius: 0.9, blast: 3, shock: true, dtype: 'energy', chain: { targets: 3, range: 26, falloff: 0.7 }, color: '#bfe9ff', color2: '#fff' } },
  { id: 'blackhole',  name: 'Black Hole Round',    cat: 'blast', cost: 30, ab: { type: 'projectile', name: 'Black Hole Round', cost: 12, cd: 12, damage: 14, speed: 62, radius: 1.6, blast: 6, grav: 0.3, singularity: { r: 28, dur: 1.2, pull: 46 }, color: '#2a2030', color2: '#9ab0d0' } },
  { id: 'vampaura',   name: 'Vampiric Aura',       cat: 'buff',  cost: 24, ab: { type: 'buff', name: 'Vampiric Aura', cost: 10, cd: 16, dur: 7, mult: 1.05, siphonAura: { r: 22, dps: 9 }, color: '#8a1d24', color2: '#ff5a4a' } },
  { id: 'adrenaline', name: 'Adrenaline Surge',    cat: 'buff',  cost: 22, ab: { type: 'buff', name: 'Adrenaline Surge', cost: 6, cd: 18, dur: 8, mult: 1.45, hpPerSec: 3.2, color: '#ff5a4a', color2: '#ffd24a' } },
  { id: 'counterst',  name: 'Counter Stance',      cat: 'buff',  cost: 22, ab: { type: 'buff', name: 'Counter Stance', cost: 5, cd: 10, dur: 2.4, mult: 1, riposte: { window: 2.4, dmg: 30 }, color: '#ffd24a', color2: '#fff' } },
  { id: 'groundspk',  name: 'Ground Spikes',       cat: 'cone',  cost: 26, ab: { type: 'cone', name: 'Ground Spikes', kiPerSec: 16, range: 44, arc: 0.5, dps: 14, dtype: 'physical', spikes: { step: 8, interval: 0.14, h: 11, r: 2.6, dur: 6, hp: 40 }, color: '#6b5f4a', color2: '#8a7a5a' } },
  { id: 'magnetpull', name: 'Magnet Pull',         cat: 'cone',  cost: 20, ab: { type: 'cone', name: 'Magnet Pull', kiPerSec: 14, range: 60, arc: 0.6, dps: 4, dtype: 'physical', magnet: { force: 64 }, push: 0, color: '#bfe9ff', color2: '#8fb0d0' } },
  { id: 'bladecyc',   name: 'Blade Cyclone',       cat: 'melee', cost: 26, ab: { type: 'nova', name: 'Blade Cyclone', cost: 7, cd: 11, feedRate: 48, maxFeed: 70, minRadius: 10, maxRadius: 20, dmgMin: 14, dmgMax: 40, dmgClass: 'slash', dtype: 'physical', cyclone: { dps: 9, dur: 1 }, color: '#dfe3e6', color2: '#fff' } },
  { id: 'sniperst',   name: 'Sniper Stance',       cat: 'gear',  cost: 24, ab: { type: 'rifle', name: 'Sniper Stance', gear: true, cost: 4, interval: 0.5, damage: 26, speed: 220, radius: 0.5, blast: 2, spread: 0.05, recoil: 4, weapon: 'pistol', stance: { settle: 0.5, spreadMult: 0.15, rateMult: 2.4, rangeMult: 2 }, color: '#eaffff', color2: '#fff' } },
  { id: 'decoy',      name: 'Decoy Hologram',      cat: 'summon', cost: 22, ab: { type: 'summon', name: 'Decoy Hologram', cost: 8, cd: 14, dur: 5, decoy: true, color: '#7fe6ff' } },
