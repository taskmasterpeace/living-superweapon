...
export const POWERS = [
  ...
  { id: 'carbine',    name: 'Assault Rifle',   cat: 'gear', cost: 14, ab: { type: 'rifle', name: 'Assault Rifle', cost: 2, interval: 0.08, damage: 5, speed: 180, radius: 0.5, blast: 2, spread: 0.05, recoil: 1.6, color: '#ffe08a', color2: '#fff' } },
  { id: 'handcannon', name: 'Heavy Pistol',    cat: 'gear', cost: 12, ab: { type: 'rifle', name: 'Heavy Pistol', cost: 5, interval: 0.34, damage: 16, speed: 150, radius: 0.8, blast: 3.5, spread: 0.015, recoil: 3.2, color: '#ffd24a', color2: '#fff' } },
  { id: 'scattergun', name: 'Combat Shotgun', cat: 'gear', cost: 14, ab: { type: 'rifle', name: 'Combat Shotgun', cost: 6, interval: 0.55, damage: 26, speed: 140, radius: 1.1, blast: 6, spread: 0.06, recoil: 4.5, color: '#ff5a4a', color2: '#fff' } },
