...
const additions=[
 ...
 ['flight','Flight air','movement','flight','Broad smooth rushing air and faint energy body following travel speed.','air',2,true,{wiring:'native-loop',nativeMethod:'updateFlightAudio',nativeNote:'Player controlled flight above hover speed; chosen recording only, intensity follows speed. Stops on landing, launch, capture, KO or removal.'}],
 ...
 ['guard-break','Guard break','melee','break','Brittle defensive crack followed by a short descending energy collapse.','metal',.45,false,{wiring:'native-replacement',nativeMethod:'Fighter.takeDamage',nativeNote:'Chosen recording plays on a resolved guard break, including energy exhaustion and heavy crush. Ordinary blocks and held guard do not trigger it.'}],
