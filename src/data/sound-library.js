...
const additions=[
 ['physical-jab-block','Melee / forearm block','melee','block','Physical fist contact against a flesh defender, reusing the selected body punch at reduced gain.','impact',.35,false,{wiring:'native-replacement',nativeMethod:'MeleeSystem._light',nativeNote:'Ordinary fist blocks on flesh only; distinct from energy barriers and blade contact. Bundled or chosen recording, with physical impact fallback.'}],
 ...[['flesh','flesh'],['metal','metal'],['stone','concrete and stone']].map(([body,surface])=>['bullet-hit-'+body,'Bullet / '+body+' impact','weapons','impact','Recorded bullet impact on '+surface+'.','impact',.4,false,{wiring:'native-replacement',nativeMethod:'Projectile.update',nativeNote:'Damaging ballistic fighter contact only. Uses explicit body material; no material guess for unknown bodies or blocked hits.'}]),
 ['flashbang-detonate','Flashbang / detonation','weapons','impact','Compact flashbang blast at the actual blinding detonation.','impact',.7,false,{wiring:'native-replacement',nativeMethod:'Game.useItem',nativeNote:'Bundled or chosen recording replaces the flashbang zap and impact; unavailable recording preserves both native sounds.'}],
 ['shieldpack-hit','Shieldpack / absorbed impact','defense','impact','Short shield impact when the personal shield absorbs damage.','impact',.4,false,{wiring:'native-replacement',nativeMethod:'Fighter.takeDamage',nativeNote:'Bundled or chosen recording on positive shield soak. True damage and hits without shield absorption do not trigger it.'}],
