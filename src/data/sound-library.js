...
const additions=[
 ...
 ['guard-break','Guard break','melee','break','Brittle defensive crack followed by a short descending energy collapse.','metal',.45],
 ['grab','Grab capture','melee','grab','Cloth snatch and compact body compression on a successful seize.','impact',.2],
