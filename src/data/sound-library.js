...
const additions=[
 ...
 ['hover','Hover pressure','movement','hover','Quiet low floating pressure with a slow airy shimmer; steady with no thrust attack.','hum',2,true],
 ['flight','Flight air','movement','flight','Broad smooth rushing air and faint energy body following travel speed.','air',2,true],
