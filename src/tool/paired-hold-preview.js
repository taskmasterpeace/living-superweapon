...
import {beginPersonCarry,syncPersonCarry,orientHeldPerson,heldPairDistance} from '../engine/person-carry.js';
export function poseHoldPair(holder,receiver,time,friendly,mode='front'){
 ...
 holder.grabbing=receiver;receiver.grabbedBy=holder;holder.grabState='clinch';holder.grabMode=friendly?'friendly':mode;
 receiver.pos.z=heldPairDistance(holder,receiver);
 ...
 orientHeldPerson(holder,receiver);
 ...
 holder._sync();receiver._sync();receiver._animate(1/60);holder._animate(1/60);
}
