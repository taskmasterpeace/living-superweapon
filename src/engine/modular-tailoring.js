...
return{set(r){const k=JSON.stringify([r.anatomy,r.bust,r.primary,r.skin,r.armor,r.coat,r.footwear,r.secondary,r.regionColors,r.businessSuit]);if(k===key)return;key=k;clear();const amount=r.bust??(r.anatomy==='female'?.45:0);
