...
export function mountInventory(game){
 ...
 function render(){
  ...
  if(policy.soldier){const armory=el('button','Open armory');armory.onclick=()=>{dialog.addEventListener('close',()=>openArmory(game,game.hud),{once:true});close();};dialog.append(armory);}
