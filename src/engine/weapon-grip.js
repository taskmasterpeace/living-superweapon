...
const centers={claws:[0,0,0],bat:[0,.15,0],nodachi:[0,.2,0],sword:[0,-.25,.16],knife:[0,-.15,.16],axe:[0,-.25,.16],spear:[0,-.25,.16],katana:[0,.2,0],baton:[0,.15,0]};
export const WEAPON_GRIP_CENTERS=centers;
