export const fleetControls = (cls,{canSwitchVehicle=false}={}) => (cls==='fixedwing'
 ? 'W/S nose down/up · A/D bank · R/F throttle +/− · G landing gear · Alt + mouse look · J exit'
 : cls==='rotor' ? 'W/S forward/back · A/D turn · Space rise · Ctrl descend · Alt + mouse look · J exit'
...
export class FleetControlsHud {
 ...
 update(actor,options){
  ...
  this.keys.textContent=fleetControls(actor.cls,options);
 }
