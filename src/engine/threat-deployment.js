...
export class ThreatDeployment {
  ...
  prepare(stage){
    ...
    [[this.threatPickHandle,'01 / CHOOSE THREAT'],[this.threatStartHandle,'02 / TEACHING DRILL'],[this.threatFightHandle,'03 / FULL POWER FIGHT'],[this.trialHandle,'04 / NEXT LESSON'],[this.trialReviewHandle,'05 / REVIEW'],[this.trialRepeatHandle,'06 / RESET PRACTICE']].forEach(([handle,title],i)=>this.room.mountTrainingConsole(handle,title,-75,-100+i*24));
    this.room.label('THREAT CONTROL / CHOOSE · PRACTICE · REVIEW',-81,23,-40,85,5,0,true).rotation.y=Math.PI/2;
