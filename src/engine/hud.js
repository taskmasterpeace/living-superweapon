...
import { CSS, CODEX_MOBILE, PHONE_CSS, TABLET_CSS } from './hud.styles.js';
...
export class HUD {
  constructor(game) {
    ...
    const s = document.createElement('style'); s.textContent = CSS + CODEX_MOBILE + PHONE_CSS + TABLET_CSS; document.head.appendChild(s);
