...
export function validateModularRecipe(input){
 ...
 const enums={tattooRegion:['chest','upperArmL','upperArmR'],capeStyle:['full','short','split','shoulder','pointed'],headwear:['none','cap','hood','speed','helmet','mask','skull'],wings:['none','angel','armor'],coatStyle:['long','short'],shieldStyle:['round','kite','riot'],weapon:['none','sword','bat','axe','spear'],frame:Object.keys(MODULAR_FRAMES),anatomy:['male','female'],infection:Object.keys(INFECTION_STYLES),patternRegion:['all','torso','arms','legs'],pattern:['solid','gilt','stripes','pinstripe','custom'],beltStyle:['plain','utility'],footwear:['boots','shoes'],gloves:['bare','full','fingerless','boxing'],emblemPlacement:['front','back','both'],hair:['swept','afro','bun','braids','none'],emblem:['triangle','shield','bolt','star','V','web','ring','deck52','none','custom',...Object.values(HERO_SIGNATURE_RECIPES).map(r=>r.emblem)],expression:['neutral','happy','angry','talkA','talkB','surprised','sad']};
...
export function emblemTexture(id){
 ...
 if(!['triangle','shield','bolt','star','V','web','ring','deck52','none'].includes(id)&&!Object.values(HERO_SIGNATURE_RECIPES).some(r=>r.emblem===id))throw Error('Unknown emblem: '+id);
