...
const support={'DEF-spine003':[-.12,0,0],'DEF-thighL':[-.15,0,-.1],'DEF-thighR':[-.15,0,.1],'DEF-shinL':[.25,0,0],'DEF-shinR':[.25,0,0],...arms(.55,.65)};
...
export const PICKUP_BODY_STUDIES={
 ...
 'Flying pickup':{hand:'both',duration:1.2,loop:false,markers:{contact:.35,release:.95,controlReturn:1.2},poses:[{time:0,joints:{}},{time:.35/1.2,joints:air},{time:.48,joints:air},{time:.65,joints:{...air,...arms(1.1,.95),'DEF-spine003':[-.12,0,0]}},{time:.95/1.2,joints:{...air,...arms(1.1,.95)}},{time:1,joints:{}}]},
};
